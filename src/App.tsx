...
export default function App() {
  ...
  const handleInsertGenerated = useCallback(
    (rawMessages: GeneratedMessage[], mode: "replace" | "append") => {
      const base = new Date();
  ...
  const handleEditTimestamp = useCallback(
    (id: string, newTimestamp: string) => {
      setMessages((prev) =>
        prev.map((m) => (m.id === id ? { ...m, timestamp: newTimestamp } : m)),
      );
    },
    [],
  );
      ...
      <div className="flex flex-col h-dvh w-screen overflow-hidden">
        ...
        >
          ...
          <div className="flex items-center gap-1.5">
            ...
            >
              <i
                className="ri-settings-3-line text-base text-xl"
                aria-hidden="true"
              />
            </Button>
            <Button
        ...
        >
          <div className="flex h-full items-stretch w-full md:w-auto">
            ...
            >
              ...
              >
                <span
                  className={`text-[9px] tracking-tight font-bold uppercase mb-1 ${colorMode === "dark" ? "text-white/40" : "text-black/40"}`}
                >
                  Platform
                </span>
                {PLATFORMS.map((p) => {
                  ...
                  return (
                    ...
                    >
                      <i
                        className={`${PLATFORM_ICONS[p]} text-base`}
                        aria-hidden="true"
                      />
              ...
              <div className="flex flex-col items-center gap-0.5 flex-1">
                ...
                {(["dark", "light"] as ColorMode[]).map((mode) => (
                  ...
                  >
                    <i
                      className={`${mode === "dark" ? "ri-moon-line" : "ri-sun-line"} text-base`}
                      aria-hidden="true"
                    />
                    <span className="text-xs font-medium leading-none">
              ...
              >
                <i
                  className="ri-download-2-line text-base"
                  aria-hidden="true"
                />
            ...
            <div className="px-4 pb-8 flex flex-col gap-5">
                ...
                <div className="flex gap-2">
                  {PLATFORMS.map((p) => {
                    ...
                    return (
                      ...
                      >
                        <i
                          className={`${PLATFORM_ICONS[p]} text-lg`}
                          aria-hidden="true"
                        />
                        <span className="text-xs font-medium leading-none">
                          {PLATFORM_LABELS[p]}
                ...
                <div className="flex gap-2">
                  {(["dark", "light"] as ColorMode[]).map((mode) => (
                    ...
                    >
                      <i
                        className={
                          mode === "dark" ? "ri-moon-line" : "ri-sun-line"
                        }
                        aria-hidden="true"
                      />
                      {mode === "dark" ? "Dark" : "Light"}
              ...
              <button
                onClick={() => {
                  ...
                  setTimeout(() => setContactDrawerOpen(true), 300);
                }}
                className="flex items-center gap-3 px-4 py-3 rounded-xl border border-black/10"
              >
                <i
                  className="ri-user-line text-base text-black/50"
                  aria-hidden="true"
                />
                ...
                <i
                  className="ri-arrow-right-s-line text-black/30 ml-auto"
                  aria-hidden="true"
                />
              </button>
          ...
          <DrawerContent>
            ...
            <div className="px-4 pb-8 flex flex-col gap-4 w-full max-w-sm mx-auto">
              ...
              <input
                ...
                style={{ fontFamily: "inherit" }}
                onKeyDown={(e) => {
                  if (e.key === "Enter") setContactDrawerOpen(false);
                }}
              />
              <Button
                variant="custom"
